...
Original project was compatible with android and iOS, but some samples only work on iOS (indicated on each case).
...
This repo: https://github.com/jaraen/TitanTricksWeb
